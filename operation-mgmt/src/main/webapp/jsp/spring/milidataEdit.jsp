...
<head>
    ...
    <meta charset="utf-8" />
    <title>ZX_IMS 2.0 - 春节活动 米粒编辑</title>
...
<body>
        <section id="container" class="">
            ...
            <jsp:include page="../common/leftmenu.jsp" flush="false">
    			...
    			<jsp:param name="s" value="9_3"/>
    		</jsp:include>
            <!--sidebar end-->

            <!--main content start-->
            <section id="main-content">
            	<form id="form1" action="${ctx}/spring/milidata/update" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="mkey" name="mkey" class="form-control" value="${dataObj.mkey }" style="width: 100%" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="orderby" name="orderby" class="form-control" style="width: 100%" value="${dataObj.orderby }" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <span class="btn btn-default"><a href="${ctx}/spring/milidata/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
