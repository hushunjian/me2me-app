...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/system/user/editSave" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">统一账号ID</label>
                                            <input type="text" id="uuid" name="uuid" class="form-control" value="${dataObj.uuid }" style="width: 100%" readonly>
                                            <input type="hidden" id="id" name="id" value="${dataObj.id }">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">统一账号名</label>
                                            <input type="text" id="uname" name="uname" class="form-control" value="${dataObj.uname }" style="width: 100%" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">APP_UID</label>
                                            <input type="text" id="appUid" name="appUid" class="form-control" value="${dataObj.appUid }" style="width: 100%" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <span class="btn btn-default"><a href="${ctx}/system/user/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
