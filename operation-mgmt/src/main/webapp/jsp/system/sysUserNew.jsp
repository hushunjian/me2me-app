...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/system/user/create" method="POST">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="uuid" name="uuid" class="form-control" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">统一账号名</label>
                                            <input type="text" id="uname" name="uname" class="form-control" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">APP_UID</label>
                                            <input type="text" id="appUid" name="appUid" class="form-control" style="width: 100%" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
