...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/appuser/createUser" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">手机号初始段</label>
                                            <input type="text" id="mobile" name="mobile" class="form-control" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">生成个数</label>
                                            <input type="text" id="count" name="count" class="form-control" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">初始密码</label>
                                            <input type="text" id="pwd" name="pwd" class="form-control" style="width: 100%" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <span class="btn btn-default"><a href="${ctx}/appuser/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
