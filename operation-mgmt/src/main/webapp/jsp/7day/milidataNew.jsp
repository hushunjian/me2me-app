...
<head>
    ...
    <meta charset="utf-8" />
    <title>ZX_IMS 2.0 - 7天活动 米粒新增</title>
...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/7day/milidata/save" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">标识key</label>
                                            <input type="text" id="mkey" name="mkey" class="form-control" value="SYSTEM_ARTICLE" style="width: 100%" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">米粒内容块</label>
                                            <textarea rows="14" style="width:100%" id="content" name="content" required>${dataObj.content }</textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="orderby" name="orderby" class="form-control" style="width: 100%" value="6" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <input type="submit" id="btnSave" value="保 存" class="btn btn-danger" />
                    <span class="btn btn-default"><a href="${ctx}/7day/milidata/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
