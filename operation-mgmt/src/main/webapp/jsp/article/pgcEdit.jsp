...
<body>
	<section id="container" class="">
		...
		<section id="main-content">
			<form id="form1" action="${ctx}/pgc/editSave" method="POST" enctype="multipart/form-data">
								...
								<div class="panel-body">
									<div role="form">
										<div class="form-group">
											...
											<input type="text" id="txtTitle" name="txtTitle" value="${dataObj.txtTitle}" class="form-control" style="width: 100%" required>
											<input type="hidden" id="pgcId" name="pgcId" value="${dataObj.pgcId }"/>
											<input type="hidden" id="qiniuImg" name="qiniuImg" value="${dataObj.qiniuImg }"/>
										</div>
										<div class="form-group">
											<label for="exampleInputFile">文章标签</label>
											<input type="text" id="txtTags" name="txtTags" class="tagsinput" style="width: 100%" value="${dataObj.txtTags}">
										</div>
									</div>
								</div>
							</section>
										...
										<div class="col-md-9">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
													<img src="${dataObj.coverImgUrl }" alt="" />
												</div>
						...
						<div class="col-lg-12">
							<section class="panel">
								...
								<div class="panel-body">
									<div role="form">
										<div class="form-group">
											<textarea id="txtContent" name="txtContent" rows="20" cols="200" style="width: 100%">${dataObj.txtContent}</textarea>
										</div>
									</div>
								</div>
							</section>
