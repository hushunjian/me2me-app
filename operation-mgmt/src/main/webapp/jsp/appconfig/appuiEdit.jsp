...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/appconfig/ui/update" method="POST">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="description" name="description" class="form-control" value="${dataObj.description }" style="width: 100%">
                                        </div>
                                        <div class="form-group">
