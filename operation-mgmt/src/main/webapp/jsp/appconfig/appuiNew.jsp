...
<body>
        <section id="container" class="">
            ...
            <jsp:include page="../common/leftmenu.jsp" flush="false">
    			...
    			<jsp:param name="s" value="7_4"/>
    		</jsp:include>
            <!--sidebar end-->

            <!--main content start-->
            <section id="main-content">
            	<form id="form1" action="${ctx}/appconfig/ui/create" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">资源标识</label>
                                            <input type="text" id="sourceCode" name="sourceCode" class="form-control" value="${dataObj.sourceCode }" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">描述</label>
                                            <input type="text" id="description" name="description" class="form-control" value="${dataObj.description }" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                    ...
                    <span class="btn btn-default"><a href="${ctx}/appconfig/ui/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
