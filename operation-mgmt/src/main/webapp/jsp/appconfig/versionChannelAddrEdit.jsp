...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/appconfig/version/channel/editSave" method="POST">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="versionAddr" name="versionAddr" class="form-control" style="width: 100%" value="${dataObj.versionAddr }">
                                        </div>
                                    </div>
                                </div>
                            </section>
