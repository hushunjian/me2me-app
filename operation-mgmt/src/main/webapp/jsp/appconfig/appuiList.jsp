...
<title>ZX_IMS 2.0 - APP主题列表</title>
	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				<form id="form1" action="${ctx}/appconfig/ui/query" method="post">
					<div class="row">
						<div class="col-lg-12">
							<section class="panel">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<span class="tools pull-right">
									<a href="${ctx}/jsp/appconfig/appuiNew.jsp" class="fa fa-plus add_link" title="添加新主题" ></a>
										...
										<tbody>
											<c:forEach items="${dataObj.result}" var="item" varStatus="status">
												<tr class="gradeX">
													...
													<th>
													<a href="${ctx}/appconfig/ui/find/${item.id }">编辑</a>
													</th>
												</tr>
											</c:forEach>
										</tbody>
