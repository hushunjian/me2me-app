...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/appconfig/lightbox/update" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="image" name="image" class="form-control" value="${dataObj.image }" style="width: 100%" required>
                                            <input type="hidden" id="id" name="id" value="${dataObj.id }">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">主文本</label>
                                            <input type="text" id="mainText" name="mainText" class="form-control" value="${dataObj.mainText }" style="width: 100%">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">副文本</label>
                                            <input type="text" id="secondaryText" name="secondaryText" class="form-control" value="${dataObj.secondaryText }" style="width: 100%">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">主色调</label>
                                            <input type="text" id="mainTone" name="mainTone" class="form-control" value="${dataObj.mainTone }" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">跳转链接</label>
                                            <input type="text" id="linkUrl" name="linkUrl" class="form-control" value="${dataObj.linkUrl }" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                    ...
                    <span class="btn btn-default"><a href="${ctx}/appconfig/lightbox/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
