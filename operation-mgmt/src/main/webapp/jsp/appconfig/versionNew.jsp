...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/appconfig/version/create" method="POST">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" style="width:100%" id="updateDescription" name="updateDescription" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">下载地址</label>
                                            <input type="text" id="updateUrl" name="updateUrl" class="form-control" style="width: 100%" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
