...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="./doSaveTopicPriceSubsidyConfig" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div role="row">
                                    	<div class="col-md-6">
	                                        <div class="form-group">
	                                            <label for="exampleInputFile">补贴级别</label>
	                                            <input name="lv"  class="form-control" value="${item.lv}" required/>
	                                        </div>
	                                        <div class="form-group">
	                                            <label for="exampleInputFile">M1</label>
	                                            <input name="m1" type="number"  class="form-control" value="${item.m1}" required/>
	                                        </div>
	                                        <div class="form-group">
	                                            <label for="exampleInputFile">M2</label>
	                                            <input name="m2"  type="number"   class="form-control" value="${item.m2}" required/>
	                                        </div>
	                                        <div class="form-group">
	                                            <label for="exampleInputFile">K1</label>
	                                            <input name="k1"  type="number"  class="form-control" value="${item.k1}" required/>
	                                        </div>
	                                        <div class="form-group">
