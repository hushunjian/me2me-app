	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				<form id="form1" action="${ctx}/stat/promoter/query" method="post">
					<div class="row">
						<div class="col-lg-12">
							<section class="panel">
							...
							<div class="panel-body">
								<div class="adv-table">
									<table class="display table table-bordered table-striped" id="dynamic-table">
										...
										<tbody>
											<c:forEach items="${dataObj.promoterDto.promoterElementList}" var="item">
												<tr class="gradeX">
													<td>${item.nickName}</td>
													<td>${item.activateCount}</td>
													<td>${item.refereeCount}</td>
													<td>${item.activateCount+item.refereeCount}</td>
												</tr>
											</c:forEach>
										</tbody>
										<tfoot>
