...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="./doSaveHotKeyword" method="POST"  >
                <section class="wrapper">
                                    ...
                                    <div role="row">
                                    	<div class="col-md-6">
	                                        <div class="form-group">
	                                            ...
	                                            <input name="keyword"  class="form-control" value="${item.keyword}" required/>
	                                        </div>
	                                        <div class="form-group">
                    ...
                    <span class="btn btn-default"><a href="./hotkeywordList">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
