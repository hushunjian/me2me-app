					...
					<div class="col-sm-12">
						<section class="panel">
							...
							<div class="panel-body">
								<div>
									<a class="btn btn-primary" href="./add_pack_detail?packId=${param.packId}">
										<i  class=" fa fa-plus "></i>
										添加新表情
									</a>
									<a class="btn btn-warning" href="./list_pack">
										返回
									</a>
								</div>
								<div class="adv-table">
										...
										<tbody>
											<c:forEach items="${dataList2}" var="item" varStatus="status">
												<tr class="gradeX">
													...
													<td>
														<a class="btn btn-warning btn-xs " href="./modify_pack_detail?id=${item.id}">编辑</a>
														<a class="btn btn-danger btn-xs " href="./delete_pack_detail?id=${item.id}&packId=${param.packId}" onclick="return confirm('确认删除吗？')">删除</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
