...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="./doSavepack" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="panel-body">
                                    <div role="row">
                                    	<div class="col-md-6">
	                                       ...
	                                       <div class="form-group">
	                                            <label for="exampleInputEmail1">表情模式</label>
	                                            <select name="emojiType" class="form-control" data-value="${item.emojiType}">
													<option value="0">中表情</option>
													<option value="1">大表情</option>
												</select>
	                                        </div>
	                                        <div class="form-group">
	                                            <label for="exampleInputEmail1">是否有效</label>
	                                            <select name="isValid" class="form-control" data-value="${item.isValid}">
		                                    ...
		                                    <div class="form-group">
	                                            <label for="exampleInputFile">表情包版本</label>
	                                            <input name="version"  class="form-control" value="${item.version}" required/>
	                                        </div>
	                                        
	                                        <div class="form-group">
	                                            <label for="exampleInputFile">分析器版本</label>
	                                            <input name="pVersion"  class="form-control" value="${item.pVersion}" required/>
	                                        </div>
		                                     
	                                         <div class="form-group">
	                                            <label for="exampleInputFile">排序号</label>
	                                            <input name="orderNum"  class="form-control number" value="${item.orderNum}" required/>
	                                        </div>   
	                                        <div class="form-group">
	                                        ...
	                                        <div class="form-group">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                        ...
                                                        <img src="http://cdn.me-to-me.com/${item.cover}" alt="" />
                                                        </c:if>
                                                    </div>
