...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="./doSavepack_detail" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div role="row">
                                        ...
                                        <div class="col-md-6">
	                                        ...
	                                        <div class="form-group">
	                                         ...
	                                         <div class="form-group">
	                                            <label for="exampleInputFile">w</label>
	                                            <input name="w"  class="form-control" value="${item.w}" required/>
	                                        </div>
	                                        
	                                        <div class="form-group">
	                                            <label for="exampleInputFile">h</label>
	                                            <input name="h"  class="form-control" value="${item.h}" required/>
	                                        </div>
                                        </div>
                                    </div>
                                </div>
