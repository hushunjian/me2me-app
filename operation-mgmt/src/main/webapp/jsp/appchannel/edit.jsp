...
<head>
    ...
    <meta charset="utf-8" />
    <title>ZX_IMS 2.0 - 更新APP渠道</title>
...
<body>
        <section id="container" class="">
            ...
            <jsp:include page="../common/leftmenu.jsp" flush="false">
    			...
    			<jsp:param name="s" value="3_4"/>
    		</jsp:include>
            <!--sidebar end-->

            <!--main content start-->
            <section id="main-content">
            	<form id="form1" action="${ctx}/appchannel/edit/save" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">渠道名</label>
                                            <input type="text" id="name" name="name" class="form-control" value="${dataObj.name }" style="width: 100%" required>
                                            <input type="hidden" id="id" name="id" value="${dataObj.id }">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">渠道标识</label>
                                            <input type="text" id="code" name="code" class="form-control" value="${dataObj.code }" style="width: 100%" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <span class="btn btn-default"><a href="${ctx}/appchannel/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
