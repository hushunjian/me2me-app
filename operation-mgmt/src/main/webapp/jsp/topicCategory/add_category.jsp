...
<body>
        <section id="container" class="">
            ...
            <jsp:include page="../common/leftmenu.jsp" flush="false">
    			...
    			<jsp:param name="s" value="12_11"/>
    		</jsp:include>
            <!--sidebar end-->

            <!--main content start-->
            <section id="main-content">
            	<form id="form1" action="./doSave" method="POST"  enctype="multipart/form-data">
                ...
                <section class="wrapper">
                                    ...
                                    <div role="row">
                                    	<div class="col-md-6">
	                                       ...
	                                       <div class="form-group">
	                                            ...
	                                            <input name="orderNum"  class="form-control" value="${item.order_num}" required/>
	                                        </div>
	                                        ...
	                                        <div class="form-group">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                    	<c:if test="${item.cover_img!=null }">
                                                        	<img src="http://cdn.me-to-me.com/${item.cover_img}" alt="" />
                                                        </c:if>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <span class="btn btn-white btn-file">
                                                            ...
                                                            <input type="file" id="image_cover" name="image_cover" class="default">
                                                        </span>
	                                         ...
	                                         <div class="form-group">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                    	<c:if test="${item.icon!=null }">
                                                        <img src="http://cdn.me-to-me.com/${item.icon}" alt="" />
                                                        </c:if>
                                                    </div>
                                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                                    <div>
                                                        <span class="btn btn-white btn-file">
                                                            <span class="fileupload-new"><i class="fa fa-paper-clip"></i>选择上传图片</span>
                                                            <span class="fileupload-exists"><i class="fa fa-undo"></i>修改</span>
                                                            <input type="file" id="image_icon" name="image_icon" class="default">
                                                        </span>
                                                        <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i>删除</a>
                                                    </div>
                                                </div>
                    ...
                    <span class="btn btn-default"><a href="./listCategory">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
