...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/zmjx/config/kingdomAdd" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="topicId" name="topicId" class="form-control" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">别名</label>
                                            <input type="text" id="alias" name="alias" class="form-control" style="width: 100%" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <span class="btn btn-default"><a href="${ctx}/zmjx/config/kingdomQuery">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
