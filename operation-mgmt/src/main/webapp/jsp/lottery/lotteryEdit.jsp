...
<body>
        <section id="container" class="">
            ...
            <section id="main-content">
            	<form id="form1" action="${ctx}/lottery/editSave" method="POST">
                <section class="wrapper">
                                ...
                                <div class="panel-body">
                                    <div role="form">
                                    	<div class="form-group">
                                            ...
                                            <input type="text" id="activityNameStr" name="activityNameStr" class="form-control" value="${dataObj.activityNameStr }" style="width: 100%" readonly>
                                            <input type="hidden" id="id" name="id" value="${dataObj.id }">
                                            <input type="hidden" id="activityName" name="activityName" value="${dataObj.activityName }">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">APP版本号</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="awardStatus" id="awardStatus" class="form-control">
												<option value="1" ${dataObj.awardStatus==1?'selected':''}>启用</option>
												<option value="2" ${dataObj.awardStatus==0?'selected':''}>未启用</option>
											</select>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">开始时间</label>
                                            <input type="text" id="startTime" name="startTime" data-mask="9999-99-99 99:99:99" value="${dataObj.startTime }" class="form-control" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">结束时间</label>
                                            <input type="text" id="endTime" name="endTime" data-mask="9999-99-99 99:99:99" value="${dataObj.endTime }" class="form-control" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">通知手机号</label>
                                            <input type="text" id="operateMobile" name="operateMobile" class="form-control" value="${dataObj.operateMobile }" style="width: 100%" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">中奖概率</label>
                                            <input type="text" id="awardSumChance" name="awardSumChance" class="form-control" style="width: 100%" value="${dataObj.awardSumChance }" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
                    ...
                    <span class="btn btn-default"><a href="${ctx}/lottery/query">返回</a></span>
                </section>
                <!-- page end-->
                </form>
            </section>
