	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				<form id="form1" action="${ctx}/lottery/query" method="post">
					<div class="row">
						<div class="col-lg-12">
							<section class="panel">
										...
										<tbody>
											<c:forEach items="${dataObj.data.result}" var="item">
												<tr class="gradeX">
													...
													<th>
													<c:choose>
                                                		<c:when test="${item.awardStatus == '1'}">
                                                			启用
                                                		</c:when>
                                                		<c:otherwise>
                                                			未启用
													...
													<th>${item.operateMobile }</th>
													<th>${item.awardSumChance }</th>
													<th>
														<a href="${ctx}/lottery/find/${item.id }">编辑</a>
														|<a href="${ctx}/lottery/prizeQuery">查看奖品</a>
													</th>
												</tr>
											</c:forEach>
										</tbody>
